...
import './EventCard.css'; // Import the CSS file for event cards
import './ProfilePage.css'; // Import a new CSS file for profile-specific styles
...
const ProfilePage = () => {
    ...
    // Fetch profile data and joined events from the backend
    useEffect(() => {
                ...
                <div className="event-info">
                    ...
                    {loading ? (
                        ...
                        joinedEvents.map((event) => (
                            <div key={event.id} className="profile-event-card"> {/* Use a unique class for profile events */}
                                <h3>{event.title}</h3>
